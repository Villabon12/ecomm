...
<div class="fashion_section">
    <div id="main_slider">
        <div class="container">
            <h1 class="fashion_taital" style="margin-top:20px;">Tarjetas regalo disponibles</h1>
                        ...
                        <div class="col-lg-3 col-sm-3">
                            <div class="box_main" style="height:598px; border-radius: 20px;">
                                ...
                                <div style="margin-bottom:100px;">
                                    <img src="<?= base_url() ?>assets/img/banner/tarjeta.jpg"
                                        width="100%" height="100%" alt="profile">
                                </div>
                                <div class="btn_main">
                                    <div class="buy_bt"><a href="#" data-bs-toggle="modal"
                                            data-bs-target="#mas_info<?= $t->id ?>">Mas info</a></div>
                                </div>
                            </div>
                        </div>
                        <!-- Modal mas info -->
                                ...
                                <form action="<? base_url() ?>/Tarjetas/compra_tarjeta/<?= $t->id ?>" method="get">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <h1 class="modal-title fs-5" id="exampleModalLabel"> Comprar tarjeta
                                                <?= $t->nombre ?>
                                            </h1>
