      ...
      <div class="login margen">
        ...
        <form class="form" action="<?= base_url() ?>Inicio_page/insertar_registrar/<?= $perfil->id ?>" method="post" enctype="multipart/form-data">
          ...
          <div class="login__row">
            ...
            <input type="text" class="login__input name plac" placeholder="Nombre" name="Nombre_enca" required />
          ...
          <div class="login__row">
            ...
            <input type="number" class="login__input pass plac" placeholder="Cédula" name="cedula" id="cedula" required />
          ...
          <div class="login__row">
            ...
            <input type="password" class="login__input pass plac" placeholder="Confirmación de contraseña" name="contra1" required />
