<body>
    ...
    <div class="main-panel">
        <div class="content-wrapper">
            ...
            <br>
            <!-- Agregar cupon modal -->
            <button type="button" class="btn btn-warning" data-bs-toggle="modal" data-bs-target="#crearproducto">
                Crear Productos
            </button>
                        ...
                        <form action="<?= base_url() ?>Comercio/guardarProducto" method="post" enctype="multipart/form-data">
                            <div class="modal-body">
                                ...
                                <div class="form-check " style="padding-left: 2rem;">
                                    <div class="row">
                                        <label class="form-check-label" style="color: black;" id="domicilio" for="flexCheckDefault">
                                            Realiza domicilios?
                                        </label>
                                ...
                                <div class="col-lg-4 col-md-3" style="padding-right: 2rem;">
                                    <div class="card btn-warning">
                                        <div class="card-body btn-warning">
                                            <img src="<?= base_url() ?>assets/img/<?= $p->img  ?>" alt="imagen" width="270px" height="250px">
