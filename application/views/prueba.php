...
<script>
  $(document).ready(function() {
    ...
    $('#tipo').on("change", function() {
      ...
      html = "";
      if (id == 1) {
        html = '<form class="form" action="<?= base_url() ?>Probar/insertar_registrar/<?= $perfil->id ?>" method="post" enctype="multipart/form-data">';
        ...
        html += '</div>'
        html += '<div class="login__row">'
        html += '<input type="email" class="login__input pass plac" placeholder="Correo" name="Correo"required  />'
        html += '</div >'
        html += '<div class="login__row">'
        html += '<input type="number" class="login__input pass plac" placeholder="telefono" name="Telefono" required />'
        html += '</div>'
        html += '<div class="login__row">'
        html += '<input type="text" class="login__input pass plac" placeholder="usuario" name="User"required  />'
        html += '</div>'
        html += '<div class="login__row">'
