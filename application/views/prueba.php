    ...
    <div class="banner_bg_main">
        ...
        <div class="logo_section">
            <div class="container">
                <div class="row">
                    <div class="col-sm-12">
                        <div class="logo"><a href="index.html"><img src="<?= base_url() ?>recursos/images/logo.png"></a></div>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="header_section">
            <div class="container">
                <div class="containt_main">
                    ...
                    <span class="toggle_icon" onclick="openNav()"><img src="<?= base_url() ?>recursos/images/toggle-icon.png"></span>
                    <div class="dropdown">
                        ...
                        <div class="lang_box ">
                            ...
                            <div class="dropdown-menu ">
                                <a href="#" class="dropdown-item">
                                    <img src="<?= base_url() ?>recursos/images/flag-france.png" class="mr-2" alt="flag">
                                    French
                                </a>
                            </div>
                        </div>
                            ...
                            <div class="row">
                                <div class="col-lg-4 col-sm-4">
                                    <div class="box_main">
                                        ...
                                        <div class="tshirt_img"><img src="<?= base_url() ?>recursos/images/tshirt-img.png"></div>
                                        <div class="btn_main">
                                ...
                                <div class="col-lg-4 col-sm-4">
                                    <div class="box_main">
                                        ...
                                        <p class="price_text">Price <span style="color: #262626;">$ 30</span></p>
                                        <div class="tshirt_img"><img src="<?= base_url() ?>recursos/images/dress-shirt-img.png"></div>
                                        <div class="btn_main">
                                            <div class="buy_bt"><a href="#">Buy Now</a></div>
                                            <div class="seemore_bt"><a href="#">See More</a></div>
                                        </div>
                                ...
                                <div class="col-lg-4 col-sm-4">
                                    <div class="box_main">
                                        ...
                                        <p class="price_text">Price <span style="color: #262626;">$ 30</span></p>
                                        <div class="tshirt_img"><img src="<?= base_url() ?>recursos/images/women-clothes-img.png"></div>
                                        <div class="btn_main">
                                            <div class="buy_bt"><a href="#">Buy Now</a></div>
                                            <div class="seemore_bt"><a href="#">See More</a></div>
                                        </div>
