$(function () {
    ...
    var e = function () {
        ...
        var e = (window.innerHeight > 0 ? window.innerHeight : this.screen.height) - 1; (e -= 75) < 1 && (e = 1), e > 75 &&
    ...
    var i, a = [
        ...
        "skin-megna-dark"];
    function o(e) {
        var i, o; return $.each(a, function (e) {
            $("body").removeClass(a[e])
        }),
            $("body").addClass(e),
            i = "skin", o = e,
            "undefined" != typeof Storage ? localStorage.setItem(i, o) : window.alert("Please use a modern browser to properly view this template!"), !1
    } (i = void ("undefined" != typeof Storage || window.alert("Please use a modern browser to properly view this template!")))
        && $.inArray(i, a) && o(i), $("[data-skin]").on("click", function (e) {
